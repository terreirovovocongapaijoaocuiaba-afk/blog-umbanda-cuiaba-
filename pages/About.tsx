  ...
  return (
    <div className="pt-32 pb-20 container mx-auto px-6 animate-fadeIn">
      ...
      <div className="text-center max-w-4xl mx-auto mb-20">
        ...
        <div className="text-xl text-stone-300 leading-relaxed whitespace-pre-wrap">
            {history}
        </div>
      </div>

      {/* Grid Images (Static placeholders as visual elements, could be made dynamic in future) */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-20">
        <div className="h-64 md:h-96 rounded-2xl overflow-hidden border border-stone-800">
        ...
        <div className="h-64 md:h-96 rounded-2xl overflow-hidden md:-mt-8 border border-stone-800 shadow-2xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-12 bg-stone-900/50 p-12 rounded-3xl border border-stone-800">
        <div className="text-center">
            <div className="w-16 h-16 bg-umbanda-red/20 text-umbanda-red rounded-full flex items-center justify-center mx-auto mb-6 border border-umbanda-red/20">
                <Sun size={32} />
            </div>
            <h3 className="text-xl font-serif font-bold text-white mb-4">Caridade</h3>
            <p className="text-stone-400 text-sm leading-relaxed">{charityText}</p>
        </div>
        <div className="text-center">
            <div className="w-16 h-16 bg-umbanda-gold/20 text-umbanda-gold rounded-full flex items-center justify-center mx-auto mb-6 border border-umbanda-gold/20">
                <Sparkles size={32} />
            </div>
            <h3 className="text-xl font-serif font-bold text-white mb-4">Fundamento</h3>
            <p className="text-stone-400 text-sm leading-relaxed">{foundationText}</p>
        </div>
        <div className="text-center">
            <div className="w-16 h-16 bg-stone-700/50 text-stone-200 rounded-full flex items-center justify-center mx-auto mb-6 border border-stone-600">
                <Moon size={32} />
            </div>
            <h3 className="text-xl font-serif font-bold text-white mb-4">Estudo</h3>
            <p className="text-stone-400 text-sm leading-relaxed">{studyText}</p>
        </div>
      </div>
    </div>
  );
